...
<div class="col-md-12 col-12 m-0 p-0" style="font-family:gilroyf
    ...
    <div class="col-md-12 col-12 m-0 p-0" style="background:#F8F8F8">
      ...
      <div class="col-md-3 text-right col-12" style="justify-content:right">
        ...
        <div class="col-md-9 d-flex py-3 call  border1 m-auto" style="justify-content:space-between ">
            <a href="https://on-track.in/about/">   <p >About Us</p></a>
            <a href="https://on-track.in/blog-2/">  <p>Blog</p></a>
            <p @click="$router.push('/termsandcondition')" style="cursor:pointer">Terms & Conditions</p>
            <a href="https://on-track.in/privacy-policy2/">  <p>Privacy Policy</p></a>
            <!-- <a href="mailto:info@on-track.in"><p>Contact Us</p></a> -->
            <a href="mailto:info@on-track.in"><p>Partner With Us</p></a>
        </div>
    <hr class="my-0 py-0">
    <div class="col-md-12 pt-2 m-0 p-0" style=" background: #4E44D8; color:white">
        <div class="col-md-9 mr-0 pr-0  d-flex py-2  border1 m-auto" style="justify-content:space-between;">
        <div class="col-md-6 m-0 p-0 text-left">
            <img src="https://on-track.in/wp-content/uploads/2020/10/logo-white.svg" alt="" width="120px" height="60px">
            <p style="font-size:12px">We are here to make your everyday travel hassle-free! We offer a wide range of two-wheelers with easy purchase options. Now your day-to-day travel can be high on affordability and extremely efficient.</p>
  ...
  <div>
    ...
    <div class="col-12 poui m-0 p-0">
      <div class="col-md-12 col-12 m-0 p-0" style="background:#F8F8F8">
        <div class="row col-md-9 pl-3  p-0 m-auto   py-5" >
          <!-- <div class=" col-12 mb-4 text-left" style="">
            <h1 class="cal">FOLLOW US</h1>
                <a href="https://www.facebook.com/ontrackBikes/">  <img src="https://cdn1.iconfinder.com/data/icons/social-media-2285/512/Colored_Facebook3_svg-128.png" alt="" width="auto" height="30px" class="pr-2"></a>
                <a  href="https://www.linkedin.com/company/ontrack-technologies-private-limited/">  <img src="https://cdn2.iconfinder.com/data/icons/social-media-2285/512/1_Linkedin_unofficial_colored_svg-128.png" alt="" width="auto" height="30px" class="pr-2"></a>
                <a href="https://www.instagram.com/ontrackbikes/">  <img src="https://cdn2.iconfinder.com/data/icons/social-media-2285/512/1_Instagram_colored_svg_1-128.png" alt=" "  width="auto" height="30px" class="pr-2"></a>    
          </div> -->
          <div class=" col-12 mb-4" style="cursor:pointer">
            <h1 class="cal text-left">Experience the mobile app</h1>
              <div class="col-md-12 d-flex m-0 p-0" style="justify-content:left;cursor:pointer">
               <a href="https://play.google.com/store/apps/details?id=com.ontrack.ontrack" target="_blank"> <img style="cursor:pointer"
                  alt="pitstop playstore"
                  src="https://cube.getpitstop.com/assets/img/playstore.png"
                  width="auto" height="50px"
      ...
      <div class="row col-12 py-3 m-0 p-0 px-3 " style=" background: #4E44D8; color:white; cursor:pointer">
        ...
        <div class="col-6  mb-3 text-left">
         ...
         <div class="col-6  mb-3 mr-0 pr-0 text-left" >
          <p @click="$router.push('/termsandcondition')">Terms & Conditions</p>
        </div>
        <div class="col-6  mb-3 text-left">
         <a href="mailto:info@on-track.in"> <p>Partner With Us</p></a>
        </div>
