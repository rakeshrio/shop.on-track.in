  ...
  <div class="col-md-12 col-12  m-0 p-0" style="box-shadow: 0 4px 12px 0 rgba(0,0,0,.05);">
    ...
    <nav class="navbar navbar-expand-sm  mt-0 pt-0 pb-0 mb-0" >
      <div class="col-md-12 col-12 m-0 p-0 d-inline">
           <div class="col-md-9 row" style="margin:0 auto;">
                ...
                <div class="col-md-8 m-0 p-0 pull-right" >
                    <div class="col-md-11 d-flex pull-right mx-0 px-0" style="justify-content:right">
                        <div class="col-md-4 text-center my-0 py-0 " >
                            <div class="col-md-12 py-2 mr-0 pr-0" style="background:#F9F9FB;border-radius:0px 0px 10px 10px; ">
                             <h6 @click="$router.push('/finance')" class="line-height text-left mb-0 pb-0" style="cursor:pointer;color:#4e44e8;font-family:gilroyf; font-size:25px">Finance</h6>
                                <p class="text-left m-0 p-0">Easy & Quick </p>
                            </div>
                        </div>
                        <div class="col-md-4 text-center my-0 py-0 " >
                            <div class="col-md-12 py-2 mr-0 pr-0" style="background:#F9F9FB;border-radius:0px 0px 10px 10px; ">
                                <a href="https://book.on-track.in"><h6 class="line-height text-left mb-0 pb-0" style="color:#4e44e8;font-family:gilroyf; font-size:25px">Rent</h6></a>
                                <p class="text-left m-0 p-0">Monthly Bike Rentals </p>
                            </div>
                        </div>
                        <div class="col-md-4 text-center my-0 py-0 " >
                            <div class="col-md-12 py-2 mr-0 pr-0" style="background:#F9F9FB;border-radius:0px 0px 10px 10px; ">
                                <a href="https://shop.on-track.in"><h6 class="line-height text-left mb-0 pb-0" style="color:#4e44e8;font-family:gilroyf; font-size:25px">Buy</h6></a>
                                <p class="text-left m-0 p-0">Buy New Bikes</p>
                            </div>
                        </div>
    ...
    <div class="col-12 m-0 p-0 nav-mobile" >
        ...
        <div v-if="close" class="col-12 py-3 text-left text-bold" style="background:#482FB5; color:white;font-size:14px;font-weight:bold">
            ...
            <!-- <div class="py-1"><p class="m-0 p-0">Login/Signup</p></div> -->
        </div>
