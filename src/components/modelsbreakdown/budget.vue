<template>
  <div class="col-md-12 col-12 my-3 p-0">
      <div class="col-md-9 col-12  text-left" style="margin:0 auto">
        ...
        <div class="col-md-12 col-6 row m-0 p-0  my-4">      
            <div class="col-md-3 col-12 m-0 p-0 pr-4 pb-4" v-for="(data,index) in allModels " :key="index" >
...
export default {
  ...
  methods: {
    fetchData() {
      this.$store.dispatch("getModelsWithBudget", {
  ...
  computed: {
    allModels() {
      return this.$store.state.getModelsWithBudget || [];
    },
    loading() {
