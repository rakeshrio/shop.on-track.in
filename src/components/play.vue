      ...
      <div class="col-md-12 row">
          ...
          <div class="col-md-4 " >
                <div class="col-md-12 m-3 p-3 " style="box-shadow: 0 1px 12px rgba(51,51,51,.12941)!important; border-radius:10px">
                    <h1 class="font2  text-left" style="">Your Order</h1>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12  text-center"  style="border:none; background:#4CAF50;border-color: #4caf50 !important;box-shadow: 0 3px 1px -2px rgb(0 0 0 / 20%), 0 2px 2px 0 rgb(0 0 0 / 14%), 0 1px 5px 0 rgb(0 0 0 / 12%); color:white;font-weight:500;letter-spacing:1px">
                        <span><i class="fa fa-shopping-cart" aria-hidden="true" style="font-size:21px"></i></span>
                        <button class="px-3 py-2 " :disabled="!valid" style="color:white;background:#4CAF50;border:none;font-size:18px; letter-spacing:1px"  @click="placeOrder"><strong>Place Order</strong></button>
                    </div>
                </div>
